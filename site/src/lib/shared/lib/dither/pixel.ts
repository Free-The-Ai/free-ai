// Standalone pixel primitives for the Dither Kit pieces (avatar, gradient,
// button). Ported verbatim from tripwire.sh dither-kit. Framework-agnostic —
// only palette.ts is shared. The Bayer matrix and bloom presets are the
// ordered-dither texture the whole kit reads as.

import { type DitherColor, PALETTE, type Rgb } from "./palette";

// 4x4 ordered (Bayer) matrix, normalized to 0-1 thresholds.
export const BAYER4 = [
    [0, 8, 2, 10],
    [12, 4, 14, 6],
    [3, 11, 1, 9],
