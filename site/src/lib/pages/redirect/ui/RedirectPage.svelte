...
<main class="root-redirect-main">
    ...
    <section class="root-redirect-card shell">
        ...
        <h1>FreeTheAi</h1>
        <p>Free OpenAI-compatible API with 80+ active models. Loading the full site at <a href="/home">/home</a>.</p>
...
.root-redirect-card :global(.primary-button) {
    justify-self: center;
}
.root-redirect-card :global(.cta-arrow) {
    opacity: 0.65;
    font-size: 0.9rem;
}
.root-redirect-logo {
