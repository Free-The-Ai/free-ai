/**
 * Motion singleton — plain module-level state, framework-agnostic like its
 * shared/lib/sound and shared/lib/theme counterparts, importable from any
 * Vue component or plain DOM listener without provide/inject wiring.
 *
