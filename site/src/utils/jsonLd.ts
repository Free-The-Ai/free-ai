export function buildWebsiteJsonLd() {
	...
	return {
		...
		description:
			'Free OpenAI-compatible API with 80+ active models. Chat completions, streaming, tool calling, and Anthropic-style messages - all behind a single free key from Discord.',
		inLanguage: 'en-US',
		publisher: {
...
export function buildOrganizationJsonLd() {
	...
	return {
		...
		description:
			'Community-run free AI API project with 80+ active models, Discord signup, optional paid slots for higher-power models, and a public searchable model catalog.',
		sameAs: [
...
export function buildSoftwareJsonLd() {
	...
	return {
		...
		operatingSystem: 'Web',
		description:
			'Free OpenAI-compatible AI API with 80+ active models, Discord key signup, streaming chat completions, tool calling, Anthropic-style messages, and a live searchable model catalog.',
		url: 'https://freetheai.xyz',
		...
		featureList: [
			...
			'Live searchable model catalog with 80+ active models',
...
export function buildWebApiJsonLd() {
	...
	return {
		...
		description:
			'Free OpenAI-compatible REST API with chat completions, streaming, tool calling, Anthropic-style messages, and 80+ active models.',
