...
<main class="setup-main">
    <section class="setup-hero shell">
        ...
        <div class="setup-cta-row">
            ...
            <a class="setup-secondary" href="/quickstart">60-second quickstart</a>
            <a class="setup-secondary" href="/models">Browse models</a>
        </div>
    </section>
    ...
    <div class="section shell setup-search-shell">
        <div class="search-field">
            ...
            <input bind:value={filterQuery} type="search" placeholder="Filter guides by client, model, or keyword..." />
        </div>
    </div>
    ...
    {#each CATEGORY_ORDER as category (category)}
        {#if guidesByCategory[category]?.length && categoryHasVisibleGuides(category)}
            <section class="section shell setup-section" id={category}>
                <header class="setup-section-head">
                ...
                <div class="setup-grid">
                    {#each guidesByCategory[category].filter(matchesGuide) as guide (guide.slug)}
    ...
    <section class="section shell setup-foot-section">
        ...
        <div class="setup-foot-links">
            ...
            <a class="setup-secondary" href="/docs#compatibility">Compatibility docs</a>
...
.setup-cta-row :global(.cta-arrow) {
    opacity: 0.65;
    font-size: 0.9rem;
}
.setup-secondary {
...
.setup-foot-links :global(.cta-arrow) {
    opacity: 0.65;
    font-size: 0.9rem;
}
...
.setup-hero > :global(*:not(.setup-glow)) {
    position: relative;
    z-index: 1;
}
</style>
