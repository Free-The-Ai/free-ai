    ...
    <div class="docs-sections">
        <article class="docs-section" id="auth">
            ...
            <section class="docs-card">
                ...
                <div class="docs-table compact">
                    <div v-for="(row, i) in authRows" :key="i" class="docs-row">
                        <code>{{ row.code }}</code>
                        <span>{{ row.span }}</span>
                    </div>
                </div>
                <div class="docs-code-group">
                    ...
                    <div v-if="baseSnippetHtml" class="shiki-wrapper" v-html="baseSnippetHtml" />
                    <pre v-else><code>{{ baseSnippet }}</code></pre>
                </div>
            </section>
        </article>
        ...
        <article class="docs-section" id="endpoints">
            ...
            <section class="docs-card">
                <div class="docs-table">
                    <div v-for="([method, routePath, desc], i) in endpoints" :key="i" class="docs-row">
                ...
                <div class="docs-code-grid">
                    <div>
                        ...
                        <div class="docs-code-group">
                            ...
                            <div v-if="chatCurlSnippetHtml" class="shiki-wrapper" v-html="chatCurlSnippetHtml" />
                            <pre v-else><code>{{ chatCurlSnippet }}</code></pre>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="docs-code-group">
                            ...
                            <div v-if="openaiSdkSnippetHtml" class="shiki-wrapper" v-html="openaiSdkSnippetHtml" />
                            <pre v-else><code>{{ openaiSdkSnippet }}</code></pre>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <article class="docs-section" id="messages">
            ...
            <section class="docs-card">
                ...
                <div class="docs-code-group">
                    <div class="docs-code-bar"><span class="docs-code-lang">bash</span><button class="copy-btn" type="button" title="Copy" aria-label="Copy to clipboard"><span class="material-symbols-outlined">content_copy</span></button></div>
                    <div v-if="messagesSnippetHtml" class="shiki-wrapper" v-html="messagesSnippetHtml" />
                    <pre v-else><code>{{ messagesSnippet }}</code></pre>
                </div>
            </section>
        </article>
            ...
            <section class="docs-card">
                ...
                <div class="docs-code-grid">
                    <div>
                        ...
                        <div class="docs-code-group">
                            <div class="docs-code-bar"><span class="docs-code-lang">bash</span><button class="copy-btn" type="button" title="Copy" aria-label="Copy to clipboard"><span class="material-symbols-outlined">content_copy</span></button></div>
                            <div v-if="modelListSnippetHtml" class="shiki-wrapper" v-html="modelListSnippetHtml" />
                            <pre v-else><code>{{ modelListSnippet }}</code></pre>
                        </div>
                    </div>
                    <div>
                        <h3>Full catalog</h3>
                        <div class="docs-code-group">
                            <div class="docs-code-bar"><span class="docs-code-lang">bash</span><button class="copy-btn" type="button" title="Copy" aria-label="Copy to clipboard"><span class="material-symbols-outlined">content_copy</span></button></div>
                            <div v-if="fullModelListSnippetHtml" class="shiki-wrapper" v-html="fullModelListSnippetHtml" />
                            <pre v-else><code>{{ fullModelListSnippet }}</code></pre>
                        </div>
                    </div>
                </div>
            </section>
...
data: [DONE]</code></pre>
                ...
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in authGateRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
                    </div>
                </div>
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in validationRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
                ...
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in rateLimitRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
                ...
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in providerRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
                ...
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in siteOnlyRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
                ...
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in headerRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
                ...
                <div class="docs-errors-group">
                    ...
                    <div class="docs-table compact">
                        <div v-for="(row, i) in oneLineRows" :key="i" class="docs-row">
                            <code>{{ row.code }}</code>
                            <span v-if="row.html" v-html="row.span" />
                            <span v-else>{{ row.span }}</span>
                        </div>
