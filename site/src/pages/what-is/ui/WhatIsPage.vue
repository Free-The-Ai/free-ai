...
const pageDescription =
    "FreeTheAi, also searched as Free The AI or Free The Ai, is a free OpenAI-compatible AI API built by Vibhek Soni to share AI tools with everyone. 80+ active models, Discord key signup, daily /checkin, no credit card.";

useSeo({
    title: "What Is Free The AI - FreeTheAi for Developers",
    description: pageDescription,
    path: "/what-is-free-the-ai",
    jsonLd: [
        buildWebsiteJsonLd(),
        ...
        buildWebApiJsonLd(),
        {
            ...
            "@type": "Article",
            headline: "What Is Free The AI",
            description: pageDescription,
            mainEntityOfPage: "https://freetheai.xyz/what-is-free-the-ai",
            author: {
                "@type": "Person",
                name: "Vibhek Soni",
                url: "https://github.com/vibheksoni",
                image: "https://avatars.githubusercontent.com/u/102437829?v=4",
            },
            publisher: { "@id": "https://freetheai.xyz/#organization" },
            image: "https://freetheai.xyz/FreeTheAi.png",
            inLanguage: "en-US",
        },
        buildBreadcrumbJsonLd([
            { name: "FreeTheAi", url: "https://freetheai.xyz/home" },
            { name: "What Is Free The AI", url: "https://freetheai.xyz/what-is-free-the-ai" },
        ]),
    ],
});
</script>
        ...
        <article class="explainer-shell shell">
            <header class="explainer-head">
                ...
                <p class="explainer-sub">
                    ...
                    <em>Free The AI API</em>, or <em>FreeTheAI</em>, this is the developer platform you want.
                </p>
                <div class="docs-hero-meta explainer-stats">
                    <span class="docs-hero-stat"><strong>80+</strong> models</span>
            ...
            <section class="explainer-card">
                ...
                <p>
                    ...
                    <a href="https://github.com/Free-The-Ai/free-ai" target="_blank" rel="noreferrer">GitHub</a>
                    and run by a small team. Meet them on the <router-link to="/team">team page</router-link>.
                </p>
            </section>

            <section class="explainer-card">
                <h2>How FreeTheAi works</h2>
                <ul class="explainer-bullets">
                    <li>Free OpenAI-compatible API at <code>https://api.freetheai.xyz/v1</code></li>
            ...
            <section class="explainer-card">
                ...
                <div class="explainer-links">
                    <router-link class="explainer-link" to="/quickstart">
                        <strong>Quickstart</strong>
                        <span>Get a key, send your first OpenAI-compatible request, see a 200 in under a minute.</span>
                    </router-link>
                    <router-link class="explainer-link" to="/docs">
                        <strong>API docs</strong>
                        <span>Chat completions, Anthropic messages, model listing, images, errors, and rate limits.</span>
                    </router-link>
                    <router-link class="explainer-link" to="/models">
                        <strong>Model catalog</strong>
                        <span>Live searchable list of every public alias, with copyable IDs and provider prefixes.</span>
                    </router-link>
                    <router-link class="explainer-link" to="/team">
                        <strong>Team</strong>
                        <span>The people behind FreeTheAi: Vibhek, Dr. Vova, and Sai Revanth.</span>
                    </router-link>
                    <router-link class="explainer-link" to="/pricing">
                        <strong>Pricing</strong>
                        <span>The free tier stays free. Optional $8/month launch slots cover separate higher-power models.</span>
                    </router-link>
                    <router-link class="explainer-link" to="/status">
                        <strong>Status</strong>
                        <span>Live provider health by alias prefix, with filterable up / degraded / down state.</span>
                    </router-link>
                </div>
            </section>

            <section class="explainer-card explainer-note">
                <h2>Frequently confused names</h2>
                <p>
                    The brand can appear written as <code>FreeTheAi</code>, <code>FreeTheAI</code>, <code>Free The AI</code>,
                    <code>Free The Ai</code>, or <code>Free TheAI</code>. They all point to the same project at
                    <a href="https://freetheai.xyz">freetheai.xyz</a>. The canonical wordmark is <strong>FreeTheAi</strong>.
                </p>
                <p>
                    FreeTheAi is unrelated to broader phrases like "free the AI" used in opinion writing or activism. If you
                    came here looking for the developer API, you are in the right place.
                </p>
            </section>
...
.explainer-link {
    ...
    transition: border-color 150ms var(--ease-out-smooth), box-shadow 150ms var(--ease-out-smooth), transform 160ms var(--ease-out-smooth);
}
.explainer-link:hover {
    border-color: oklch(0.659 0.192 40.1 / 0.42);
    box-shadow: var(--sk-inset-shadow), 0 0 0 1px oklch(0.659 0.192 40.1 / 0.18), 0 0 12px oklch(0.659 0.192 40.1 / 0.12);
...
.explainer-stats .docs-hero-stat strong {
    font-size: 1.25rem;
    color: var(--accent-text);
...
.explainer-cta-row .cta-arrow {
    opacity: 0.65;
    font-size: 0.9rem;
}
.explainer-link strong {
    font-family: var(--font-mono);
    font-size: 0.92rem;
    color: var(--accent-text);
    text-shadow: var(--accent-text-glow);
