    ...
    <article class="explainer-shell shell">
        <header class="explainer-head">
            ...
            <div class="explainer-cta-row">
                ...
                <a class="explainer-secondary" href="/quickstart">Read the quickstart</a>
            </div>
        </header>
        ...
        <section class="explainer-card">
            ...
            <p>
                ...
                and run by a small team. Meet them on the <a href="/team">team page</a>.
            </p>
        </section>
...
:global(.explainer-glow) {
    z-index: 0;
}
.explainer-head > :global(*:not(.explainer-glow)) {
    position: relative;
    z-index: 1;
}
.explainer-head h1 {
...
.explainer-stats :global(.docs-hero-stat strong) {
    font-size: 1.25rem;
    color: var(--accent-text);
...
.explainer-cta-row :global(.cta-arrow) {
    opacity: 0.65;
    font-size: 0.9rem;
}
...
.explainer-foot :global(.cta-arrow) {
    opacity: 0.65;
    font-size: 0.9rem;
}
.explainer-secondary {
