...
<canvas
    bind:this={canvasEl}
    aria-hidden="true"
    style="position: absolute; inset: 0; width: 100%; height: 100%; image-rendering: pixelated; pointer-events: none; opacity: 1"
></canvas>
