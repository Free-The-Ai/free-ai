        ...
        <div class="support-grid">
            <article class="panel support-card">
                ...
                <div class="support-email-group docs-code-group">
                    ...
                    <button class="copy-btn" type="button" title="Copy email" aria-label="Copy email address" onclick={copyEmail}>
...
.support-email-group :global(.copy-btn) {
    position: static;
    opacity: 0.55;
    width: 22px;
    height: 22px;
}
.support-email-group:hover :global(.copy-btn),
.support-email-group :global(.copy-btn:focus-visible) {
    opacity: 1;
}
.support-section {
    margin-top: -18px;
